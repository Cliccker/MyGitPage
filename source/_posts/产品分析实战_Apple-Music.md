...
![两种不同的交互](https://my-picbed.oss-cn-hangzhou.aliyuncs.com/20210903142205.png)

+ **需求：**方便查阅历史记录&快速翻阅待播清单，同时保持视觉上的简洁

+ **思考：**我非常喜欢这个交互，他帮助我理解了《设计心理学》这本书中`示能`这一概念。作为示能符号，`列表`无需多做说明就可以让用户理解到它是可以滑动的。

  > 示能符号：不需要标签或说明书的帮助，帮助人们了解可以采取什么行动来操作。

### 喜爱&踩

+ **特征：**操作页面，用户能够给歌曲比较**喜爱**和**踩**
+ **需求：**标记喜欢的音乐，让推荐算法更准确
